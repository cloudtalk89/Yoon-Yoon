...
const SupriseSection = () => {
  return (
    <section className='min-h-screen flex items-center justify-center flex-col gap-10 font-bold'>
      <h2 className='text-lg md:text-3xl text-white font-bold flex items-center justify-between p-4 z-10'><Link to="/"  className='p-2 border rounded-xl text-sm px-4 cursor-pointer bg-white text-violet-500 mr-6'>Back</Link> <span>🎉 Birthday Gift 🎉</span></h2>
      <section className='grid grid-cols-1 md:grid-cols-2 gap-6 p-2'>
        <Link className='flex flex-col items-center justify-between p-6 rounded-2xl bg-violet-600 z-10 gap-2 hover:scale-105 transition-all duration-150' to='/moments'>
